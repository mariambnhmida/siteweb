              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0"> Historique De Participation </h5>
                        ...
                        <table class="table">
                            <thead>
                              <tr>
                                ...
                                <th class="font-weight-bold">Chapitre</th>
                                <th class="font-weight-bold">Etat</th>
                                <th class="font-weight-bold">Consulté le </th>
                              </tr>
                            </thead>
                            <tbody>
                                @foreach ($historiqparticipationparties as $l)
                                    <tr>
                                    @foreach($users as $user)
                                    ...
                                    <td>
                                        @if ($l->etat == 'oui')
                                        <div class="badge badge-success p-2">Consulté<i class="fas fa-add"></i> </div>
                                        @endif
                                        @if ($l->etat == '' )
                                        <div class="badge badge-warning p-2">{{$l->etat}} <i class="fas fa-add"></i> </div>
                                        @endif
                                        </td>
                                    <td> {{$l->created_at->translatedFormat('d M Y à H\hi')}}</td>
                                  </tr>
                                  @endforeach
                            </tbody>
                          </table>
