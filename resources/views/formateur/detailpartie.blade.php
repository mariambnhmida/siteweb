              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0"> Détail Chapitre</h5>
                    </br>
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive border rounded p-1">
                          <table class="table table-bordered table-striped">
                              ...
                              <tr>
                                <th>Formation</th>
                                <td>{{$parties->formations->nom}}</td>
                              </tr>
                              <tr>
                                <th>Description de chapitre</th>
                                <td>{{$parties->descp}} </td>
                              </tr>
                                  <tr>
                                    <th>Vidéo</th>
                                    <td><video id="bande" class="video-js" controls preload="auto" width="400" height="200" data-setup="{}">
                                        <source src="/{{$parties->video}}" type='video/mp4'> </video>
                                    </td>
                                  </tr>

                                  <tr>
                                    <th>Gratuitée</th>
                                    <td>{{$parties->gratuite}}</td>
                                  </tr>
