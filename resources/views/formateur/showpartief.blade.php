              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0">Mes Chapitres</h5>
                    </br>
                  ...
                  <div class="d-md-flex row m-0 quick-action-btns" role="group" aria-label="Quick action buttons">
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn btn-outline-warning btn-icon-text">
                                ...
                                <a href="{{route('addpartie',[$formation->id])}}" style="color:rgb(18, 16, 16)"><i class="icon-folder-alt"></i>  Ajouter Chapitre</a>
                                @endforeach
                       </button>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Video</th>
                            <th class="font-weight-bold">Détails</th>
                            <th class="font-weight-bold">Historique des participants</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($formations as $formation)
                            @foreach ($formation->parties as $f)
                              <br>
                            <tr>
                            <td>{{$f->nom}}</td>
                            <td>{{$f->descp}}</td>
                            <td>
                              <video id="bande" class="video-js" controls preload="auto" width="200" height="100" data-setup="{}">
                              <source src="/{{$f->video}}" type='video/mp4'> </video>
                             </td>
                             <td> <button type="button" class="btn btn-warning btn-sm" >
                                <a href="{{route('detailpartie',$f->id)}}" style="color:rgb(253, 251, 249)">
                                 Consulter
                                </a>
                            </button>
                             </td>
                                  <td><button type="button" class="btn btn-warning btn-sm" >
                                    <a href="{{route('historiqp',$formation->id)}}" style="color:rgb(253, 251, 249)">
                                     Consulter
                                    </a>
                                </button>
                                  </td>
                          ...
                          <td>
                            <button type="button" class="btn btn-success btn-sm" >
                                <a href="{{route('editpartie',['id'=>$f->id])}}" style="color:rgb(253, 251, 249)">
                        ...
                        <form action="{{route('DeletePartie')}}" method="post" onsubmit="return confirm('Etes-vous sur  de supprimer?');">
                        @csrf
