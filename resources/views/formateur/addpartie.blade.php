                ...
                <div class="col-md-12 grid-margin">
                  <div class="card">
                    <div class="card-header d-block d-md-flex">
                      ...
                      <p class="ml-auto mb-0">Les titres de sujet sont affichés publiquement chaque fois que nécessaire. <i class="icon-bulb"></i></p>
                    </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="forms-sample"  method="post" action="{{route('addpartiepost')}}" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Vidéo de nouveau chapitre *</label>
