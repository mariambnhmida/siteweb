            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="forms-sample"  method="post" action="{{route('Editp')}}" enctype="multipart/form-data" >
                        @csrf
                      <div class="form-group">
                        <h4 >Informations sur le chapitre</h4><br>
                        <h5>Ajouter des détails de votre formation pour aider les apprenants à le découvrir</h5>
                        <input type="text" name="user_id" value="{{Auth::user()->id}}" hidden>
                        <input type="hidden" name="id" value="{{$partie->id}}" hidden>
                        <input type="text" name="etatp" value="Fermé" hidden>
                        <label for="exampleInputUsername1">Titre du chapitre*</label>
                        <input type="text" class="form-control" name="nom" value="{{ $partie->nom}}">
                        <div>
                         @if ($errors->has('nom'))
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control"name="descp" value="{{ $partie->descp}}" >
                        </textarea>
                        <div>
                         @if ($errors->has('descp'))
                      ...
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Vidéo*</label>
                        <input type="file" class="form-control" name="video"  value="{{ $partie->video}}">
                        <div>
                         @if ($errors->has('video'))
                      ...
                      <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" name="gratuite"  id="customSwitch1" value="{{ $partie->gratuite}}">
                        <label class="custom-control-label" for="customSwitch1">Gratuité*</label>
                      </div>
                      <br>
