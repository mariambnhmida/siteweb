              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0">Gain Totale<br></h5>
                              ...
                              <div class="card">
                                  <div class="card-body">
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="d-sm-flex align-items-baseline report-summary-header">
                                          ...
                                          <span class="ml-auto">
                                            <h5><a href="{{ route('historiqueretrait') }}"  style="color:rgb(18, 16, 16)">Historique des retraits</a></h5>
                                          </span>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row report-inner-cards-wrapper">
                                      ...
                                      <div class="col-md-6 col-xl report-inner-card">
                                        <div class="inner-card-text">
                                          <span class="report-title"><a href="{{ route('historiqueretrait') }}"  style="color:rgb(18, 16, 16)">Mes retraits</a></span>
                                          <br>
                                          <h4 style="color:rgb(251, 4, 4);"> {{$countF}} TND
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title ">Ici vous pouvez consulter vos revenus </h4>
                    </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td>{{$gains->created_at->translatedFormat('d M Y à H\hi')}}</td>
                               <td>
                                <div class="progress">
                               ...
                               <td>{{$gains->gainF}} TND</td>
                                <td>
                                    ...
                                    @endif
                                    @if ($gains->etatG == 'chèque')
                                    <label class="badge badge-success">{{$gains->etatG}}</label>
                                    @endif
                                    @if ($gains->etatG == 'virement_instantané')
                                    <label class="badge badge-success">{{$gains->etatG}}</label>
                                    @endif
