                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Sous Catégories</th>
                            <th class="font-weight-bold">Niveau</th>
                            <th class="font-weight-bold">Visibilité</th>
                         ...
                         <td>
                          <div>
                            <button type="button" class="btn btn-warning btn-sm" >
                                <a href="{{route('formationdetails',$f->id)}}" style="color:rgb(253, 251, 249)">
                                    <i class="bi bi-eye menu-icon"></i>
                                </a>
                            </button>
                            <button type="button" class="btn btn-success btn-sm" >
                                <a href="{{route('ShowEditFormation',['id'=>$f->id])}}" style="color:rgb(253, 251, 249)">
                        ...
                        <form action="{{route('DeleteFormation')}}" method="post" onsubmit="return confirm('Etes-vous sur  de supprimer?');">
                        @csrf
