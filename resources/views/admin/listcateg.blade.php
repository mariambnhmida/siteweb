            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
              ...
              <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                  ...
                  <a class="dropdown-item" href="{{route('ShowEditcompteA',['id'=>Auth::user()->id])}}"><i class="dropdown-item-icon icon-user text-primary"></i> Mon profile <span class="badge badge-pill badge-danger">1</span></a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn px-0" > <a href="{{ route('addcateg') }}">
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Mots Clés</th>
                            <th class="font-weight-bold">Sous catégorie</th>
                        ...
                        @foreach ($cats as $c)
                            ...
                            <td>  <button type="button" class="btn btn-warning btn-sm" >
                                <a href="{{route('adminShowSsouscategorie',$c->id)}}" style="color:rgb(253, 251, 249)">Détails
                                <i class="bi bi-eye menu-icon"></i>
                                </a>
                            </button>
                         <td>
                            <button type="button" class="btn btn-success btn-sm" >
                                <a href="{{route('ShowEditC',['id'=>$c->id])}}" style="color:rgb(253, 251, 249)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path>
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"></path>
                                        </svg>                                </a>
                            </button>
                            <form action="{{route('DeleteC')}}" method="post" onsubmit="return confirm('Etes-vous sur  de supprimer?');">
                                @csrf
