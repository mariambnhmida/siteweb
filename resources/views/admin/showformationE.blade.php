                ...
                <div class="col-md-12 grid-margin">
                  <div class="card">
                    <div class="card-header d-block d-md-flex">
                      <h5 class="mb-0">Historique d'achat Formations</h5>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Affiche</th>
                            <th class="font-weight-bold">Prix</th>
                            <th class="font-weight-bold">Date d'achat</th>
                            <th class="font-weight-bold">Historique participations</th>
                          </tr>
                        </thead>

                        <tbody>

                            @foreach ($achatformations as $l)
                                <tr>
                                <td>{{$l->id}}</td>
                                <td>@if (isset($l->formation_id)) {{$l->formations->nom}} @endif</td>
                                <td> <img src="{{asset('/'.$l->formations->image)}}" class="img-fluid"  width="80px" height="80px"></td>
                                <td> {{$l->prix}} Jetons</td>
                                <td> le {{$l->created_at->translatedFormat('d M Y à H\hi')}}</td>
                              <td><button type="button" class="btn btn-success btn-sm" >
                                <a href="{{route('showparticipation',$l->formation_id)}}" style="color:rgb(253, 251, 249)">Détails
                                <i class="bi bi-eye menu-icon"></i>
                                </a>
                            </button>
                                </td>
