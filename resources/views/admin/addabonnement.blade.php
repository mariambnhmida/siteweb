              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample"  method="post" action="{{ route('adda') }}" enctype="multipart/form-data" >
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Abonnement*</label>
                        <input type="text" class="form-control" name="nom" placeholder="Nom d'Abonnement" required>
                        <div>@if ($errors->has('nom'))
                        <strong style="color: red;">{{ $errors->first('nom') }}</strong>
                         @endif</div>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Description de l'abonnement*</label>
                        <input type="text" class="form-control"name="desca" placeholder="Description" required>
                        <div>
                        @if ($errors->has('desca'))
                        <strong style="color: red;">{{ $errors->first('desca') }}</strong>
                         @endif
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Nombre de jeton*</label>
                        <input type="text" class="form-control"  name="jeton"  placeholder="Nombre de jetons" required>
                        <div>
                        @if ($errors->has('jeton'))
                        <strong style="color: red;">{{ $errors->first('jeton') }}</strong>
                         @endif
                        </div>
                        </br>
                        <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control"  name ="prix" aria-label="Amount (to the nearest dollar)"placeholder="Prix d'abonnement" required >
                        @if ($errors->has('prix'))
                      ...
                      <a href="{{route('listabonnement')}}"button class="btn btn-light">Annuler</button></a>
                    </form>
                  </div>
                </div>
              </div>
