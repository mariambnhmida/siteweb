            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                <a class="dropdown-item py-3">
                  <p class="mb-0 font-weight-medium float-left">Vous avez des messages</p>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                  ...
                                  <th class="font-weight-bold">Vidéo</th>
                                  <th class="font-weight-bold">Gratuité</th>
                                </tr>
                              </thead>
                              <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-success btn-sm" >
                                    <a href="{{asset($p->video)}}" style="color:rgb(253, 251, 249)">Détails
                                    <i class="bi bi-eye menu-icon"></i>
                                    </a>
                                    </button>
                                </td>
