                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td>{{$scat->id}}</td>
                              <td>@if (isset($scat->cat_id)) {{$scat->cats->nom}} @endif</td>
                              <td>{{$scat->nom}}</td>
                              <td>
                                <button type="button" class="btn btn-warning btn-sm" >
                                    <a href="{{route('adminShowScategorie',$scat->id)}}" style="color:rgb(253, 251, 249)">
                                    <i class="bi bi-eye menu-icon"></i>
                                    </a>
                                </button>
                                <button type="button" class="btn btn-success btn-sm" >
                                    <a href="{{route('ShowEditS',['id'=>$scat->id])}}" style="color:rgb(253, 251, 249)">
