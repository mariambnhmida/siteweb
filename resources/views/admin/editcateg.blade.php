          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample"  method="post" action="{{route('EditC')}}" enctype="multipart/form-data" >
                   ...
                   <br>
                    @csrf
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nom" value="{{ $cats->nom}}">

                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Description</label>
                        <input type="text" class="form-control"name="desc" placeholder="Description"  value="{{ $cats->desc}}">

                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Mots Clés</label>
                        <input type="text" class="form-control"  name="mots_cles"  placeholder="Mots Clés"  value="{{ $cats->mots_cles}}">

                      </div>

                      <button  type="submit" class="btn btn-success pull-right">Modifier</button>
                      <a href="{{route('listcateg')}}"button class="btn btn-light">Annuler</button></a>
                    </form>
                  </div>
                </div>
              </div>
