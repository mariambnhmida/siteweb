              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0"> Liste des messsages</h5>
                    <p class="ml-auto mb-0"><i class="icon-bulb"></i></p>
                  </div>
                  <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                    <button type="button" class="btn px-0" >
                        <a href="{{ route('contacta') }}">Nouveau Message  <i class="bi bi-arrow-up-right-square-fill"></i></a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-striped">
                      ...
                      <td>{{$contacta->id}}</td>
                      <td>{{$contacta->to}}</td>
                        <td>{{$contacta->objet}}</td>
                        <td>{{$contacta->msg}}</td>
                        <td>{{$contacta->created_at}}</td>
                      <td>
                          <form action="{{route('Deletemsg')}}" method="post" onsubmit="return confirm('Etes-vous sur  de supprimer?');">
                        @csrf
                            <input type="hidden" name="_token" value="{{ Session::token() }}">
                             <input type="hidden" name="id" value="{{ $contacta->id }}">
