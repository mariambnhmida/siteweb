                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Jetons</th>
                            <th class="font-weight-bold"><center>Formations</th>
                        ...
                        @foreach ($users as $l)
                            <tr>
                            <td>{{$l->id}}</td>
                            <td><img src="{{asset('/image/'.$l->profile_photo_path)}}" class="img-fluid"  width="80px" height="80px"></td>
                            <td>{{$l->name}}</td>
                            <td>{{$l->email}}</td>
                            ...
                            <td><center>
                                <button type="button" class="btn btn-success btn-sm" >
                                    <a href="{{route('showformationE',$l->id)}}" style="color:rgb(253, 251, 249)">
                                    <i class="bi bi-eye menu-icon"></i>
                                    </a>
                                </button>
                            </td>
