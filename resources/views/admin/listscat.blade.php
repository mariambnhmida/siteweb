          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <li class="nav-item nav-category">
              ...
              <li class="nav-item">
                  ...
                  <span class="menu-title">Gérer Categories</span>
                ...
                <div class="col-md-12 grid-margin">
                  <div class="card">
                    <div class="card-header d-block d-md-flex">
                      <h5 class="mb-0">Gérer sous catégories</h5>
                    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn px-0" > <a href="{{ route('addscat') }}">
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Catégories</th>
                            <th class="font-weight-bold">Déscription</th>
                        ...
                        @foreach ($scats as $s)
                            ...
                            <td>{{$s->mots_cles}}</td>
                         <td>
                            <a class="btn btn-success" href="{{route('ShowEditS',['id'=>$s->id])}}"  role="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"></path>
                            </svg>
                        </a>
                         <form action="{{route('DeleteS')}}" method="post" onsubmit="return confirm('Etes-vous sur  de supprimer?');">
                            @csrf
