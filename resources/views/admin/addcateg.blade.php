          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">FORM Catégorie</h4>
                    <form class="forms-sample"  method="post" action="{{route('addc')}}" enctype="multipart/form-data" >
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Catégorie*</label>
                        <input type="text" class="form-control" name="nom" placeholder="Nom du catégorie" required>
                      ...
                      <div class="form-group">
                        ...
                        <div>@if ($errors->has('desc'))
                        <strong style="color: red;">{{ $errors->first('desc') }}</strong>
                         @endif</div>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Mots Clés*</label>
                        <input type="text" class="form-control"  name="mots_cles"  placeholder="Mots Clés" required>
