              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0">Liste des parrains</h5>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Parrain</th>
                            <th class="font-weight-bold">Email</th>
                            <th class="font-weight-bold">Parriné(e) par</th>
                            <th class="font-weight-bold">Etat</th>
                          </tr>
                        </thead>
                        <tbody>
                        @foreach ($parrainages as $l)
                            <tr>
                            <td>{{$l->id}}</td>
                            <td>{{$l->new_id}}</td>
                            <td>{{$l->mail}}</td>
                            ...
                            <td>
                            @if ($l->etat == 'parrinée')
                            <div class="badge badge-success p-2">{{$l->etat}} <i class="fas fa-add"></i> </div>
                            @endif
