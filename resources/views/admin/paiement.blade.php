                        ...
                        <div class="table-responsive border rounded p-1">
                          <table class="table table-bordered table-striped">
                            @foreach ($gainsformateur as $gains )
                              ...
                              <tr>
                                <th>Gain totale</th>
                                <td>{{$gains->prixformation}}.000 TND </td>
                              </tr>
                              <tr>
                                  <th>Mes Gains</th>
                            ...
                            <tr>
                                <th> Gains Formateur</th>
                                <td>{{$gains->gainF}} TND</td>
                          </tr>
                          @endforeach
                          <form action="{{route('payf')}}" method="post" >
                            @csrf
                            <input type="hidden" name="id" value="{{ $gains->id }}">

                            <input type="hidden" class="form-control" name="gainformateur" value="{{$gains->gainF}}" >
                            <input type="hidden" class="form-control" name="gainadmin" value="{{$gains->gainA}}">
                            <input type="hidden" class="form-control" name="form_id" value="{{$gains->formateur_id}}">
                            <input type="hidden" class="form-control" name="gain_id" value="{{$gains->id}}">
                            <input type="hidden" class="form-control" name="etatG" value="{{$gains->etatG}}">
                              ...
                              <tr>
                                ...
                                <td>
                                    ...
                                    <option value="virement_instantané">Virement instantané</option>
                              ...
                              <tr>
                                ...
                                <td>
                                 <div class="form-group">
                                    <input type="text" class="form-control" name="commentaire" placeholder="Ecrire un commentaire" required>
                                  </div>
                                </td>
                               </tr>
                               <tr>
