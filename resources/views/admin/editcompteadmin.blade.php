          ...
          <div class="content-wrapper">
                    ...
                    <div class="col-md-12 grid-margin">
                      <div class="card">
                        <div class="card-header d-block d-md-flex">
                          <h5 class="mb-0">Paramétres du compte</h5>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Modifier votre compte</h4>

                    <form class="forms-sample"  method="post" action="{{route('EditCompteA')}}" enctype="multipart/form-data" >
