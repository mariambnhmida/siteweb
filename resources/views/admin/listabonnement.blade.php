              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0">Gérer Abonnements</h5>
                    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn px-0" > <a href="{{ route('addabonnement') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash" viewBox="0 0 16 16">
                            <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                            <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
                            </svg>
                          Ajouter Abonnement</a>
                      </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Nombre de jeton</th>
                        ...
                        @foreach ($abonnements as $abonnement)
                            ...
                            <td>{{$abonnement->desca}}</td>
                            <td>{{$abonnement->jeton}}</td>
                            <td>{{$abonnement->prix}} .dt</td>
                            <td>
                                <button type="button" class="btn btn-success btn-sm" >
                                    <a href="{{route('ShowEditA',['id'=>$abonnement->id])}}" style="color:rgb(253, 251, 249)">
                            ...
                            <form action="{{route('DeleteA')}}" method="post" onsubmit="return confirm('Etes-vous sur  de supprimer?');">
                            @csrf
