            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
              ...
              <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                  ...
                  <a class="dropdown-item" href="{{route('ShowEditcompteA',['id'=>Auth::user()->id])}}"><i class="dropdown-item-icon icon-user text-primary"></i> Monn compte <span class="badge badge-pill badge-danger">1</span></a>
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0">Historique d'achat des abonnements</h5>
                    <p class="ml-auto mb-0">
                        <a href="{{route('historiqformations')}}" class="card-title ml-auto mb-3 mb-sm-0"  style="color:hsl(0, 0%, 100%);">Historique d'achat formations</a>
                        <i class="icon-bulb"></i></p>
                  </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Apprenant</th>
                            <th class="font-weight-bold">Nom d'abonnement</th>
                            <th class="font-weight-bold">Prix d'abonnement</th>
                            <th class="font-weight-bold">Date d'achat</th>
                          </tr>
                        </thead>
                        <tbody>
                        @foreach ($achatsjetons as $l)
                            <tr>
                            <td>{{$l->id}}</td>
                            @foreach($users as $user)
                            ...
                            @foreach($abonnements as $a)
                              @if ($a->id == $l->abonnement_id)
                            <td>{{$a->nom}} </td>
                              @endif
                            @endforeach
                            <td>{{$l->prix}} dt</td>
                            <td> Le {{$l->created_at->translatedFormat('d M Y à H\hi')}}</td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
