              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    <h5 class="mb-0">Formations diponibles</h5>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Bande annonce</th>
                            <th class="font-weight-bold">Formateur</th>
                            <th class="font-weight-bold"><center>Action</th>
                          </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            <td><a href="{{asset($f->image)}}">Voir</a> </td>
                            <td><a href="{{asset($f->bande)}}">Voir</a></td>
                            @foreach($users as $user)
                          ...
                          @endforeach
                            <td><center>
                                <button type="button" class="btn btn-success btn-sm" >
                                    <a href="{{route('showdetailF',$f->id)}}" style="color:rgb(253, 251, 249)">Détails
                                    <i class="bi bi-eye menu-icon"></i>
                                    </a>
                                </button>
                          </tr>
