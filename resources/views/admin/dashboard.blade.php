    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Bienvenue Espace Administrateur </h5>
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                <a class="dropdown-item py-3">
                  <p class="mb-0 font-weight-medium float-left">Vous avez reçus {{$count}} message(s)</p>
                  <a href="{{route('showmsgg')}}">
                ...
                <a class="dropdown-item preview-item">
                    @foreach($contacts as $contact)
                      <div class="preview-thumbnail">
                        ...
                        <img src="{{$user->profile_photo_path  }}" class="img-sm profile-pic">
                      </div>
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                ...
                <a class="dropdown-item" href="{{route('showmsgg')}}"><i class="dropdown-item-icon icon-speech text-primary"></i>Messages<span class="badge badge-pill badge-danger">{{$count}}</span></a>
            ...
            <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="d-sm-flex align-items-baseline report-summary-header">
                            <h5 class="font-weight-semibold">Résumé du rapport
                            </h5> <span class="ml-auto">
                                <a href="{{ route('redirects') }}">Actualiser</span>
                                     <button class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></a></button>
                          </div>
                        </div>
                      </div>
                      <div class="row report-inner-cards-wrapper">
                        <div class=" col-md -6 col-xl report-inner-card">
                          <div class="inner-card-text">
                            <span class="report-title">Formateurs</span>
                            <h4>{{$count0}}</h4>
                            <span class="report-count"> <a href="{{ route('showformateur') }}">Voir </a></span>
                          </div>
                        ...
                        <div class="col-md-6 col-xl report-inner-card">
                          <div class="inner-card-text">
                        <span class="report-title">Apprenants</span>
                            <h4>{{$count1}}</h4>
                            <span class="report-count"><a href="{{ route('showetudiant') }}">Voir </a></span>
                          </div>
                        ...
                        <div class="col-md-6 col-xl report-inner-card">
                          <div class="inner-card-text">
                            <span class="report-title">Formations</span>
                            <h4>{{$count2}}</h4>
                            <span class="report-count"> <a href="{{ route('consulterformation') }}">Voir </a></span>
                          </div>
                        ...
                        <div class="col-md-6 col-xl report-inner-card">
                          <div class="inner-card-text">
                            <span class="report-title">Nombre d'inscriptions à nos formations</span>
                            <h4>{{$count3}}</h4>
                            <span class="report-count"> <a href="{{ route('historiqformations') }}">Voir </a></span>
                          </div>
              ...
              <div class="row">
                <div class="col-md-4 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Statistique Globale</h4>
                      <div class="aligner-wrapper">
                        ...
                        <canvas id="sessionsDoughnutChart" height="165" style="display: block; height: 132px; width: 189px;" width="236" class="chartjs-render-monitor"></canvas>
                        <div class="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                          <h2 class="text-center mb-0 font-weight-bold">{{$total}}</h2>
                          <small class="d-block text-center text-muted  font-weight-semibold mb-0">Totale</small>
                        </div>
                      </div>
                      <div class="wrapper mt-4 d-flex flex-wrap align-items-cente">
                        <div class="d-flex">
                          <span class="square-indicator bg-danger ml-2"></span>
                          <p class="mb-0 ml-2">Formateurs</p>
                        </div>
                        <div class="d-flex">
                          <span class="square-indicator bg-success ml-2"></span>
                          <p class="mb-0 ml-2">Formations</p>
                        </div>
                        <div class="d-flex">
                          <span class="square-indicator bg-warning ml-2"></span>
                          <p class="mb-0 ml-2">Achat Formations</p>
                        </div>
                      </div>
                    </div>
                  </div>
