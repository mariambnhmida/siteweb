                    ...
                    <div class="col-md-12 grid-margin">
                      <div class="card">
                        <div class="card-header d-block d-md-flex">
                          <h5 class="mb-0">Modifier Abonnement</h5>
                        </div>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample"  method="post" action="{{route('EditA')}}"  >
                    <input type="hidden" name="_token" value="{{ Session::token() }}">

                   <input type="hidden" name="id" value="{{ $abonnements->id }}">

                   <br>
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Abonnement</label>
                        <input type="text" class="form-control" name="nom" value="{{ $abonnements->nom}}">

                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Description de l'abonnement</label>
                        <input type="text" class="form-control"name="desca"   value="{{ $abonnements->desca}}">

                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Nombre de jeton</label>
                        <input type="text" class="form-control"  name="jeton"    value="{{ $abonnements->jeton}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Prix</label>
                        <input type="text" class="form-control"  name="prix"   value="{{ $abonnements->prix}}">
