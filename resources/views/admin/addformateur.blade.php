                ...
                <div class="col-md-12 grid-margin">
                  <div class="card">
                    <div class="card-header d-block d-md-flex">
                      <h5 class="mb-0">Merci de remplir le formulaire</h5>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample"  method="post" action="{{route('addf')}}" enctype="multipart/form-data" >
                        @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="phone" class="form-control" name="phone" placeholder="Numéro de téléphone" required>
                      ...
                      <div class="form-group">
                        <input type="hidden" class="form-control" name="pourcentage" value="10" >
                      </div>
