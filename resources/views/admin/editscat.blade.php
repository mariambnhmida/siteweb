                    ...
                    <div class="col-md-12 grid-margin">
                      <div class="card">
                        <div class="card-header d-block d-md-flex">
                          <h5 class="mb-0">Modifier Sous Catégories</h5>
                        </div>
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="forms-sample"  method="post" action="{{route('EditS')}}"  >
                        <input type="hidden" name="id" value="{{ $scats->id }}">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Sous catégorie</label>
                        <input type="text" class="form-control" name="nom" value="{{ $scats->nom}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Description</label>
                        <input type="text" class="form-control"name="desc" placeholder="Description"  value="{{ $scats->desc}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach($categs as $v)
                            <option value="{{$v->id}}" @if ($v->nom == $scats->cats->nom) selected  @endif>{{$v->nom}}</option>
                            @endforeach
                            </select>
                        </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Mots clés</label>
                        <input type="text" class="form-control"  name="mots_cles"  placeholder="Mots Clés"  value="{{ $scats->mots_cles}}">
                      </div>
