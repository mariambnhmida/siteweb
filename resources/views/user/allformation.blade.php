  ...
  <main id="main">
    <section id="courses" class="courses">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
              <div class="col-lg-12">
                <ul id="portfolio-flters">
                    <center>
                    <p  ><a href="{{('allformation')}}" style="color:rgb(249, 135, 5);" >Tous les Formations en ligne</a> <a href="#portfolio" class="btn-get-started scrollto" style="color:orange"  style="background-color:#fffefe;">
                     + de  @foreach ( $pojects as $pro)
                      {{$pro->views}}
                      @endforeach
                      Visites
        ...
        <div class="container aos-init aos-animate" data-aos="fade-up">
            @foreach ($cats as $cat)
            <li class="dropdown">
                <a href="{{route('categ',$cat->id)}}" style="color:rgb(249, 135, 5);">
                    <span>Meilleurs formation dans la catégorie : {{$cat->nom}}</span><i class="bi bi-chevron-right"></i><br>
                </a><br>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                ...
                <div class="course-content">
                  ...
                  <p>{{$formation->descf}}</p>
                  <p class="description">Cette formation comprend : {{ \DB::table('parties')->where('formation_id',$formation->id)->count()}} Chapitre(s)<br></p>
    ...
    <div class="footer-top">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links" style="color:rgb(249, 135, 5);">
            <h4>Liens utiles</h4>
            <ul>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
                @foreach ($cats as $cat)
                    <li>
                     <i class="bx bx-chevron-right" style="color:rgb(249, 135, 5);"></i><a href="{{route('categ',$cat->id)}}"><span>{{$cat->nom}}</span></a>
                    </li>
                  @endforeach
