    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Rchercher des formations</h1>
          <br>
          <form action="{{ route('web.find') }}" method="GET">
            <input type="text" class="form-control" name="query" placeholder="Rechercher par formation....." value="{{ request()->input('query') }}">
            <span class="text-danger">@error('query'){{ $message }} @enderror</span>

            <div align="center">
            <button type="submit" class="btn-get-started scrollto">Recherche</button>
            </div>
        </form>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="{{asset('site/assets/img/search.gif')}}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="footer-newsletter">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <h4>Une nouvelle génération 100% en ligne.</h4>
            <br>
            @if(isset($formations))
            <div align="center">
                ...
                <tbody>
                    @if(count($formations) > 0)
                        @foreach($formations as $formation)
                           <tr align="center">
                               <td><a href="{{route('detailsformation',['id'=>$formation->id])}}">{{ $formation->nom }}  </a></td>
                               <td  width="100px" height="100px"><img src="{{$formation->image}}"  class="img-fluid"  width="100px" height="100px"></td>
                               <td style="font-size:25px;">{{ $formation->descf }}</td>
                               <td><a href="{{route('detailsformation',['id'=>$formation->id])}}"> Voir formation</a></td>
                           </tr>
                        @endforeach
                    @else
            ...
            <div class="pagination-block">
                ...
                {{  $formations->appends(request()->input())->links('user.paginationlinks') }}
            </div>
