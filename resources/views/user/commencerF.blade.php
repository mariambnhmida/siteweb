      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
            <video width="600" height="500" controls allow=" autoplay">
          ...
          <div class="col-lg-6 pt-5 pt-lg-0">
            ...
            <div class="row">
                <p data-aos="fade-up" data-aos-delay="100">
                    <a href="{{route('allchapitres', $formations->id)}}" class="portfolio-lightbox"  style="color:rgb(249, 135, 5);"> Cette formation comprend : {{$count}} chapitre(s) </a>
                </p>
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <h4> {{$count}} Chapitre(s)</h4>
                <div> Votre niveau :
                @if ( $historiqparticipationpartie == $count )
                <div class="badge badge-success p-2">
                {{$historiqparticipationpartie}} / {{$count}}
                </div>
                @endif
                @if ( $historiqparticipationpartie < $count )
                <div class="badge badge-warning p-2">
                {{\DB::table('historiqparticipationparties')->where('formation_id',$formations->id)->count()}} / {{$count}}
                </div>
                @endif
                </div>
                </div>
              ...
              <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <h4>  Notes globale d'utilisteurs</h4>
              ...
              <div>
                  <div>
                    <button type="button" class="btn btn-outline-danger">
                        ...
                        <a href="{{route('allchapitres', $formations->id)}}"  class="bi bi-link" style="color:orange">Commencer</a>
                    </button>
                    <button type="button" class="btn btn-outline-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
                           <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"></path>
                        </svg>
                        <a href="{{route('viewnote', $formations->id)}}"class="portfolio-lightbox" style="color:orange" >Commenter</a>
                      </button>
                   </div>
              </div>
            </div>
  ...
  <section id="pricing" class="pricing">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        <div class="section-title">
            <p>Contenu de la formation : <br> {{$count}} Chapitre(s)</p>
            <p> Votre niveau : {{\DB::table('historiqparticipationparties')->where('formation_id',$formations->id)->count()}} / {{$count}}</p>
          </div>
      <div class="row">
        @foreach ($part as $p)
          ...
          <div class="box featured">
            ...
            <ul>
              ...
              <h4><span>En ligne et à votre rythme</span><h4>
                <a href="{{route('chapitre',['id'=>$p->partie_id])}}" class="btn-buy" style="background-color:red;">Commencer</a>
            </ul>
            @endif
            ...
            <div class="btn-wrap">
              <a href="{{route('chapitre',['id'=>$p->partie_id])}}" class="btn-buy" >Consulté <i class="bi bi-patch-check" style="color: rgb(255, 255, 255)"></i></a>
            </div>
            @endif
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6">
        @if ($count== $counth)
        <div class="box featured">
            <h3> Obtenir votre certificat <i class="bi bi-award"></i></h3>
            <ul>
                <li><span>Certificat de fin de formation</span></li>
                <h4><span>Certificat de fin de formation</span><h4>
                </ul>
          <div class="btn-wrap">
            <a href="{{route('certif',['id'=>$formations->id])}}" class="btn-buy" class="btn-buy">Obtenir <i class="bi bi-award" style="color: rgb(255, 255, 255)"> </i></a>
        </div>
        </div>
        @endif
        @if ($count > $counth)
        <div class="box featured">
          ...
          <div class="btn-wrap">
            <a href="#" class="btn-buy" class="btn-buy" style="background-color:red;">Obtenir <i class="bi bi-award" style="color: rgb(255, 255, 255)"> </i></a>
        </div>
        </div>
        @endif
