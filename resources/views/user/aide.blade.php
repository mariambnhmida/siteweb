    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Bienvenue Back {{ Auth::user()->name }}  </h1>
          <h2>Avec notre système d'aide à la décision c'est facile à trouver des  formations qualifiantes !</h2>
          <div>
            <a href="{{route('allformation')}}" class="btn-get-started scrollto">Commencer</a>
          </div>
        </div>
  ...
  <section id="services" class="services section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>Formations recommandé pour vous</h2>
        <p>Les formations qui vont vous intéresser</p>
      </div>
      <div class="row">
      @php
          $x = 0;
      ...
      <div class="col-md-3 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="{{$x+=100}}">
          <div class="icon-box">
              <div class="icon"><img src="{{$form->image}}" class="img-fluid" width="110" height="40"></div>
            <h4 class="title"><a href="">{{$form->nom}}</a></h4>
            <p class="description">Description:{{$form->descf}}</p>
            <p class="description">Nombre de jeton: {{$form->abonnement->jeton}} Jetons</p>
            <p class="description">Niveau:{{$form->niveau}}</p>
            <p class="badge badge-success p-2">En ligne et à votre rythme<i class="fas fa-add"></i> </p>
            <p>{{\ DB::table('notes')->where('formation_id',$form->id)->sum('note')*5 /100}}/5 <img src="{{asset('site/assets/img/stars.gif')}}" class="img-fluid animated" width="100" height="10"></p>
            <a href="{{route('achatformations',['id'=>$form->id])}}" class="btn-get-started scrollto">Commencer<i class="bi bi-cart3"></i></a>
          </div>
      </div>
      @endforeach
      @endforeach
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="{{$x+=100}}">
            <div class="icon-box">
              ...
              <p class="description">Prix: {{$abonnement->prix}}.dt</p>
              <div>
...
<section id="about" class="about">
        ...
        <div class="col-lg-6 pt-5 pt-lg-0">
          ...
          <div class="row">
            ...
            <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4>Des Jetons à gagner</h4>
              <p> <a href="{{route('showparrain')}}">Invitez vos amis et gagnez des jetons</a></p>
            </div>
            <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
              <i class="bi bi-cash-coin"></i>
              <h4>Des prix  raisonnable</h4>
              <p><a href="{{route('showabonnement')}}"> Achetez des jetons et abonnez vous</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="team" class="team">
        <div class="container">
            ...
            <div align="center">
            <p> À notre site, Nous croyons que pour converger le meilleur, vous devez apprendre et suivre le meilleur .</p>
            </div>
        <div class="row">
    ...
    <!-- ======= Clients Section ======= -->
    <section id="abonnements" class="clients section-bg">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
          <h2>Atteignez vos objectifs.</h2>
            <p>Tracez votre chemin vers la réussite. </p>
          </div>
          <div class="clients-slider swiper" data-aos="fade-up" data-aos-delay="100">
            <div class="swiper-wrapper align-items-center">
                @foreach ($formations1 as $form)
                <div class="swiper-slide">
                    <a href="{{route('detailsformation',['id'=>$form->id])}}">
                    <img src="{{$form->image}}" class="img-fluid"></div>
                     </a>
                @endforeach
            </div>
      ...
      <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
        <li>
          ...
          <div id="faq1" class="collapse" data-bs-parent=".faq-list">
            <p>
                Apprenez les compétences les plus demandées pour les métiers d'aujourd'hui , avec notre plate-forme une nouvelle génération 100% en ligne.
            </p>
          </div>
        </li>
        ...
        <li>
          <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">Comment gagnez des jetons ? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
          <div id="faq3" class="collapse" data-bs-parent=".faq-list">
            <p>
                Recommender nos services à vos proches et à chaque nouveau parrainage validé vous Gagnez des jetons pour commencer un leçon.         </p>
          </div>
        </li>
        <li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
                @foreach ($cats as $cat)
                <li> <i class="bx bx-chevron-right"></i><a href="{{route('categ',$cat->id)}}"><span>{{$cat->nom}}</span></a>
                  @endforeach
            </ul>
          </div>
