            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                ...
                <div class="course-content">
                  ...
                  <p>Note : {{\ DB::table('notes')->where('formation_id',$formation->id)->count()*5 /100}}/5 <img src="{{asset('site/assets/img/etoiles.gif')}}" class="img-fluid animated" width="70" height="10"></p>
