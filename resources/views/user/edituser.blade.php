...
<li>
    <a class="getstarted scrollto" href="{{ route('showparrain') }}" ><i class="icon-user-follow"></i> Ajouter un parrain</a></li>
...
<div class="col-lg-5 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
  <div class="info">
    <div class="col-lg-12 d-flex align-items-center justify-content-center about-img">
            <img src="{{asset('site/assets/img/update.gif')}}" class="img-fluid" alt="" data-aos="zoom-in">
          </div>
</div>
</div>
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <form action="{{route('EditCompteU')}}" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
                @csrf
              <div class="row">
              ...
              <div class="form-group col-md-6 mt-3 mt-md-0">
                ...
                <div class="form-group col-md-6">
                  <label for="name">Photo de profile</label>
                  <input type="file" name="profile_photo_path" class="form-control"  value="{{$users->profile_photo_path}}">
                </div>
                <div class="form-group col-md-6">
                  <label for="name">Curriculum vitæ (CV sous format PDF)</label>
                  <input type="file" name="cv" class="form-control"  value="{{ $users->cv}}">
                </div>

              <div class="text-center"><button type="submit">Modifier<i class="icon-note"></i></button>
              <a href="{{route('redirects')}}"button class="btn btn-light"><i class="icon-reload btn-icon-prepend"></i> Annuler </button></button></a>
              </div>
            </form>
          </div>
        </div>
