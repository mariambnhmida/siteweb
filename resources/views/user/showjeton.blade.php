  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
       ...
       <li>
           <a class="getstarted scrollto" href="{{ route('showparrain') }}" ><i class="icon-user-follow"></i> Parrainez vos amis</a></li>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Félicitations , votre nombre totale de jetons est : {{Auth::user()->jeton}} <i class="bi bi-cash-coin "></i> </h1>
          <div>
            <a href="#services" class="btn-get-started scrollto">Recharger votre compte</a>
          </div>
        </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Abonnement</h2>
          <p>Découvrez les packs  que nous offrons</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="{{$x+=100}}">
                <div class="icon-box">
                  ...
                  <p class="description"> Nombre de jetons : {{$abonnement->jeton}}</p>
                  <p class="description">Prix: {{$abonnement->prix}}.000 dt</p>
                  <div>
