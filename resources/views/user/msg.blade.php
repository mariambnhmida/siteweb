...
<div class="col-lg-5 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
  <div class="info">
    <div class="col-lg-12 d-flex align-items-center justify-content-center about-img">
            <img src="{{asset('site/assets/img/about-img.svg')}}" class="img-fluid" alt="" data-aos="zoom-in">
          </div>
</div>
</div>
                ...
                <div align="center">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach($contactas as $contact)
                                   <tr>
                                    ...
                                    @if ($user->id == $contact->user_id)
                                       <td  width="100px" height="100px"><img src="{{asset('adminn/images/faces/face8.png')}}"  class="img-fluid"  width="100px" height="100px"> {{$user->name}}</td>
                          ...
                          <td><button  class="btn btn-outline-danger btn-fw" ><a href="{{route('repondre')}}">Répondre</a></button></td>
                        </tr>
                         @endforeach
                        </tbody>
