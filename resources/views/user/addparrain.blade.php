...
<li>
    <a class="getstarted scrollto" href="{{ route('showparrain') }}" >
        <i class="icon-user-follow"></i> Ajouter un parrain</a></li>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1> Parrainer , c'est gagnez !</h1>
          <h2>Recommender nos services à vos proches et à chaque nouveau parrainage validé vous  Gagnez des jetons pour commencer un leçon.</h2>
          <div>
            <a href="#contact" class="btn-get-started scrollto">JE PARRAINE</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="{{asset('site/assets/img/parr.gif')}}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Parrainer vos proches ! </h2>
          <p>Recommender vos proches et bénéficiez de l'offre de Parrainage !</p>
        </div>
        <div class="row">
        <div class="col-lg-5 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
        <div class="info">
        <div class="col-lg-14 d-flex align-items-center justify-content-center about-img">
            <img src="{{asset('site/assets/img/parr.png')}}" class="img-fluid"  data-aos="zoom-in">
        </div>
        </div>
        </div>
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <form action="{{route('addpar')}}" method="post"  >
              @csrf
              <div class="row">
                  <input type="text" name="user_id" value="{{Auth::user()->id}}" hidden>
                  <select style="visibility:hidden;" name="etat"  class="form-control" >
                  <option  value="en attente">en attente</option>
                  <option  value="parrainé">parrainé</option>
                  </select>
              <div class="form-group mt-3">
                <label for="name">Prénom de votre filleul(e)*</label>
                <input type="text" class="form-control" name="new_id"  placeholder="PRENOM DE VOTRE FILLEUL(E)" required>
                <div>
                     @if ($errors->has('new_id'))
                         <strong style="color: red;">{{$errors->first('new_id')}}</strong>
                         @endif
                </div>
              </div>
                <div class="form-group mt-3">
                  <label for="name"> Email de votre filleul(e)*</label>
                  <input type="email" class="form-control" name="mail"  placeholder=" EMAIL DE VOTRE FILLEUL(E)" required>
                  <div>
                  @if ($errors->has('mail'))
              ...
              <button  type="submit" class="btn btn-warning" style="background-color:rgb(255, 143, 7);">JE PARRAINE PAR EMAIL</button></div>
            </form>
          </div>
        </div>
      </div>
 ...
 <section id="clients" class="clients section-bg">
    <div class="container" data-aos="fade-up">
      <div class="section-title">
        ...
        <p>Tracez votre chemin vers la réussite et bénéficier de nos formations .</p>
      </div>
