            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
              ...
              <li>
                  <a class="getstarted scrollto" href="{{ route('showparrain') }}" >
                    <i class="icon-user-follow"></i> Parrainez vos amis</a>
                </li>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>{{ Auth::user()->name }} , prêt pour vos achats ?</h1>
          <h2>Acheter des jetons pour apprendre nos leçons ,  avec notre plate-forme une nouvelle génération 100% en ligne.</h2>
          <div>
            <a href="#services" class="btn-get-started scrollto">Passer vos achats</a>
          </div>
        </div>
