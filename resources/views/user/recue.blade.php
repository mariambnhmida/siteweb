    		...
    		<div class="row">
    			<div class="col-xs-6">
    				...
    				<strong>Reçue:
    					...
    					E-Learning<br>
    					Tunis,Tunisia<br>
    				<a href="http://localhost:8000/">Trainingeasily.tn</a>
    				</address>
    			</div>
    	...
    	<div class="col-md-12">
    		<div class="panel panel-default">
    			<div class="panel-heading">
    				<h3 class="panel-title"><strong>Formation</strong></h3>
    			</div>
    					...
    					<table class="table table-condensed">
    						<thead>
                                <tr>
        							...
        							<td class="text-center"><strong>Commandé</strong></td>
    						...
    						<tbody>
    							...
    							<tr>
                                    ...
                                    @endif
                                    @endforeach
    								<td class="text-center">{{$ach->created_at}}</td>
    								<td class="text-center">{{$ach->prix}}.000 TND</td>
    								<td class="text-right">1</td>
                                    <td class="text-right">{{$ach->prix}}.000 TND</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								<td class="no-line text-center"><strong>Total réglé</strong></td>
    								<td class="no-line text-right">{{$ach->prix}}.000 TND</td>
    							</tr>
                                @endforeach
    						</tbody>
    					</table>
