    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Bienvenue Back {{ Auth::user()->name }} , prêt pour votre prochaine leçon?</h1>
          <h2>Apprenez les compétences les plus demandées pour les métiers d'aujourd'hui , avec notre plate-forme une nouvelle génération 100% en ligne.</h2>
          <br>
          <div>
          ...
          <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
            ...
            <li>
              ...
              <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                <p>
                  E-learning est une plate-forme en ligne qui vous rapproche des principaux formateurs talentueux et vous aide à apprendre les compétences les plus enrichissantes tout au confort de votre maison ,avec notre plate-forme une nouvelle génération 100% en ligne.              </p>
              </div>
            </li>
